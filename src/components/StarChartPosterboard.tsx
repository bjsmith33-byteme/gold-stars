...
import { useBsTheme } from "../lib/theme";
 ...
 *
 * The names/counts are decorative (it's a picture of a star chart, not live data).
 */
export default function StarChartPosterboard({
  theme = "auto",
  className = "",
  style = {},
}: {
  ...
  return (
    <div className={className} style={style}>
      <svg
        style={{ "--sc-ink": ink } as CSSProperties}
        width="100%"
        viewBox="0 0 680 430"
