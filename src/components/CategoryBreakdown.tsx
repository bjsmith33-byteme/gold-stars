...
import { AREA_EMOJI, type CategoryTally } from "../lib/aggregate";
import { SpecialtyBadge } from "./SpecialtyBadge";

/** One card per knowledge area, listing who's earned stars there (most first).
 *  Everyone tied for the top count in an area gets a 🥇 — the goal is to surface
 *  the growing experts per area, not crown a single monthly winner. */
