...
import type { Supporter } from "../lib/aggregate";
 ...
 *  Renders nothing if no one awarded a star that month. Sits where a future
 *  "Learner of the Month" can join it side by side. */
